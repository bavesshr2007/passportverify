...
import type { PassportApplication as _PassportApplication, UserProfile as _UserProfile, UserRole as _UserRole } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async getAllApplications(): Promise<Array<PassportApplication>> {
        if (this.processError) {
            try {
    ...
    async getApplicationById(arg0: bigint): Promise<PassportApplication> {
        if (this.processError) {
            try {
                const result = await this.actor.getApplicationById(arg0);
                return from_candid_PassportApplication_n4(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
    ...
    async getApplicationStatus(arg0: bigint): Promise<PassportApplication> {
        if (this.processError) {
            try {
    ...
    async getMyApplications(): Promise<Array<PassportApplication>> {
        if (this.processError) {
            try {
    ...
    async lookupByPassportNumber(arg0: string): Promise<PassportApplication> {
        if (this.processError) {
            try {
                const result = await this.actor.lookupByPassportNumber(arg0);
                return from_candid_PassportApplication_n4(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async rejectApplication(arg0: bigint, arg1: string): Promise<void> {
        if (this.processError) {
            try {
    ...
    async submitApplication(arg0: string, arg1: string, arg2: string, arg3: string, arg4: string, arg5: string, arg6: string, arg7: string, arg8: string): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.submitApplication(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_PassportApplication_n4(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _PassportApplication): PassportApplication {
...
function from_candid_vec_n3(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_PassportApplication>): Array<PassportApplication> {
    return value.map((x)=>from_candid_PassportApplication_n4(_uploadFile, _downloadFile, x));
}
